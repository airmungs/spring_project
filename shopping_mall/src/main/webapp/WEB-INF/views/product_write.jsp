...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/resources/css/product.css?<%= System.currentTimeMillis() %>">
...
<script src="/resources/js/admin/product_write.js?<%= System.currentTimeMillis() %>"></script>
</html>
